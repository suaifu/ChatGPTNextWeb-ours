...
const cn = {
  ...
  Error: {
    Unauthorized:
      "现在是未授权状态，请点击页面猫🐱头获取使用方式，新上线ChatGPT快捷指令 (https://kjgpt.guoshuaifu.cn) 欢迎使用，访问密码请添加微信即可获取：makerKwok ",
  },
  ChatItem: {
  ...
  Store: {
    DefaultTopic: "新的聊天",
    BotHello:
      "你好呀，你知道的我可以会，你不知道的我也可以会，使用ChatGPT快捷指令 (https://kjgpt.guoshuaifu.cn) 来帮你快速使用，有什么想向我提问的吗？添加微信防丢失：makerKwok",
    Error: "出错了，稍后重试吧",
    Prompt: {
